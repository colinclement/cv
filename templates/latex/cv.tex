...
%\usepackage[backend=biber,style=ieee,defernumbers,maxnames=3,url=false,doi=false]{biblatex}
%\usepackage[backend=biber,defernumbers,maxnames=3,url=false,doi=false]{biblatex}
\usepackage[bibstyle=numeric,defernumbers,maxnames=3,minnames=3,url=false,
            doi=false,sorting=ydnt]{biblatex}

% Hides numbering in bibliography
